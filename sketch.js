...
function setup(){
    ...
    box10 = new Box(800,240,70,70);
    box11 = new Box(800,160,70,70);
    box12 = new Box(800,160,70,70);
    box13 = new Box(700,320,70,70);
    box14 = new Box(700,320,70,70);
    box15 = new Box(700,240,70,70);
    box16 = new Box(700,240,70,70);
    box17 = new Box(700,160,70,70);
    box18 = new Box(700,160,70,70);
    box19 = new Box(700,160,70,70);
    box20 = new Box(700,160,70,70);

    bird = new Bird(200,200, 80, 80, 0);
